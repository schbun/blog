...
var containerWidth = zCanvasDiv.clientWidth > 0 ? zCanvasDiv.clientWidth : 400; // Default a 400px
var FRAMESIZE = Math.min(containerWidth, 450);
//
var STROKECOLOR = "#A0C0FF"; 
//
...
$('#zCanvas').mousemove(function(e) {
	if(paint)
	{
        ...
        var scaleX = zCanvas.width / rect.width;
        var scaleY = zCanvas.height / rect.height;
		addClick((e.pageX - this.offsetLeft) * scaleX, (e.pageY - this.offsetTop) * scaleY, true);
		redraw();
	}
});
...
$('#zCanvas').mousedown(function(e){
    ...
    var scaleX = zCanvas.width / rect.width;
    var scaleY = zCanvas.height / rect.height;
	var mouseX = (e.pageX - this.offsetLeft) * scaleX;
	var mouseY = (e.pageY - this.offsetTop) * scaleY;
...
window.addEventListener('resize', () => {
    var newContainerWidth = zCanvasDiv.clientWidth > 0 ? zCanvasDiv.clientWidth : 400;
    FRAMESIZE = Math.min(newContainerWidth, 450);
